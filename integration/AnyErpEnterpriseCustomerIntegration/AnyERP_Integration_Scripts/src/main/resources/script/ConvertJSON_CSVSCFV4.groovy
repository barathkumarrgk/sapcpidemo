/**
 * DD-V2 format for Early Payment JSON to CSV
...
class CsvFile {
    ...
    String headers = """\"autoRequested","creator","businessUnit","invoiceErpId","supplierNumber","supplierSite","status","transactionid","platformSignature","supplierBankName","supplierBankBranchNumber","supplierBankCity","supplierBankRegion","supplierBankStreet","supplierBankCountry","supplierBankaccountNumber","supplierBankNumber","supplierBankControlKey","supplierBankSwiftNumber","supplierBankIban","financeDate","financeType","type","originalMaturityDate","erpInvId","discountPercent","amount","balanceResult","invoiceId","discountAmount","erpBankId","erpBankHash\""""    
